...
def update_account_settings(requesting_user, update, username=None):
    ...
    if changing_username and check_html(update['name']):
        field_errors["name"] = {
            "developer_message": u"Error thrown from validate_name: '{}'".format('Full Name is in-valid'),
            "user_message": u"This value is in-valid"
        }
